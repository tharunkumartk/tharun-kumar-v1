      ...
      <div className="">
        ...
        >
          <T>
            ...
            in AI research and engineering. Aside from working on fun projects
            and learning as much as I can about the world,{" "}
            <span className="font-medium text-stone-900 dark:text-white">
              I&apos;m looking for intense and fast-paced environments where I
              can ship products and push boundaries towards AGI
            </span>
            .
            <br />
            <br />
